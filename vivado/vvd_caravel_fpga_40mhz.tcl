...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/mm.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/qsort.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB_Decode.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB2AXI_FIR.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB2AXI_MM.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/WB2AXI_QSORT.v"]"\
 ...
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/uart_ctrl_fifo.v"]"\
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/user_project_wlos_wp.v"]"\ 
 "[file normalize "$origin_dir/vvd_srcs/caravel_soc/rtl/user/exmem_sdram.v"]"\
...
set script_file "vvd_caravel_fpga_10MHz.tcl"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/vitis_prj/hls_caravel_ps"] [file normalize "$origin_dir/vitis_prj/hls_output_pin"] [file normalize "$origin_dir/vitis_prj/hls_read_romcode"]" $obj
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  set_property -dict [list CONFIG.NUM_PORTS {3} CONFIG.IN0_WIDTH {32} CONFIG.IN2_WIDTH {5}] [get_bd_cells xlconcat_0]
  set_property -dict [list CONFIG.IN0_WIDTH {5} CONFIG.IN2_WIDTH {32}] [get_bd_cells xlconcat_0]
  connect_bd_net [get_bd_pins axi_uartlite_0/tx] [get_bd_pins xlconcat_0/In1]
  connect_bd_net [get_bd_pins caravel_0/mprj_i] [get_bd_pins xlconcat_0/dout]
  #connect_bd_net [get_bd_pins caravel_ps_0/mprj_in] [get_bd_pins xlslice_1/Din]
  #connect_bd_net [get_bd_pins caravel_ps_0/mprj_in] [get_bd_pins xlslice_2/Din]
  #connect_bd_net [get_bd_pins xlslice_1/Dout] [get_bd_pins xlconcat_0/In0]
...
set obj [get_runs synth_1]
set_property -name "auto_incremental_checkpoint.directory" -value "/home/tonyho/workspace_willy/caravel_fpga/project/vitis_prj/hls_read_romcode/D:/Caravel_Soc/vvd_caravel_fpga/vvd_caravel_fpga.srcs/utils_1/imports/synth_1" -objects $obj
